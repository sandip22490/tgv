...
exports.aliases = ['i']
exports.desc = 'Example: tgv install 1.0.11'
exports.builder = {
  'verbose': {
...
exports.handler = async () => {
  ...
  if (!result.find(v => v === version)) {
    console.log(`${P_ERROR}Terragrunt ${version} not found.${P_END}`);
    console.log(`To view a list of available version, run ${P_OK}tgv list --remote${P_END}`);
    process.exit(1);
  }
